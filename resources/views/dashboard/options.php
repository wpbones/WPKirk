...
<div class="wp-kirk wrap wp-kirk-sample">
    ...
    <div class="wp-kirk-toc-content">
        ...
        <p>You may also store <code>null</code> values</p>

        <pre><code class="language-php">$value = $plugin->options->get( 'General.option_5'); echo is_null($value) ? 'null' : $value; // <?php $value = $plugin->options->get(
                    'General.option_5'
                );
                echo is_null($value) ? 'null' : $value ?></code></pre>
        ...
        <p>Of course, you'll be able to define any default value if the branch/key doesn't exist.</p>
        ...
        <pre><code class="language-php">$plugin->options->set( 'Special.Name', null );</code></pre>

        <?php $plugin->options->set('Special.Name', null); ?>
        <pre><code class="language-json"><?php echo $plugin->options; ?></code></pre>
        ...
        <?php $plugin->options->set('Special.null_value', null); ?>

        <pre><code class="language-php">$plugin->options->set( 'Special.null_value', null );</code></pre>
        ...
        <p>In accordance with the options structure, you may also update a whole subset of options instead of changing
            them individually.</p>
  ...
  [ 'General' =&gt;
    [ 'option_4' =&gt;
      [ 'color' =&gt; 'red', 'background' =&gt; 'transparent', 'images' => null ]
    ]
  ]
);</code></pre>
  ...
  [ 'General' =&gt;
    [ 'option_5' =&gt;
      [ 'color' =&gt; 'red', 'background' =&gt; 'transparent', 'images' => null ]
        ...
        <p>To delete an option, you have to use the <code>delete()</code> method</p>
